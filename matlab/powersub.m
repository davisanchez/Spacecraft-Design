...
%Batteries
battery_weight_primary = C_r/45 %[kg], for NiH2
battery_weight_secondary = C_r/85 %[kg], for li ion
battery_weight=2*battery_weight_primary+2*battery_weight_secondary %2 batteries, demander
